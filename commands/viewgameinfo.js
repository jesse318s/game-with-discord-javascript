...
const sendGameInfo = (interaction, gameInfo, imgFiles) => {
  const summon = creatures[gameInfo[3]];
  const chosenRelic = relics[gameInfo[4]];
  ...
  interaction
    .reply({
      embeds: [
        ...
        Attack: ${summon.attackName} (${
              summon.attack + chosenRelic.attackMod
            }, ${summon.attackType})
...
module.exports = {
  ...
  async execute(interaction) {
    ...
    sendGameInfo(interaction, gameInfo, imgFiles);
  },
};
